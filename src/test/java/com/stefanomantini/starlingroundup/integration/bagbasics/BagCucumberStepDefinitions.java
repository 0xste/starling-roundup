package com.stefanomantini.starlingroundup.integration.bagbasics;

import com.stefanomantini.starlingroundup.integration.bagcommons.BagHttpClient;
...
public class BagCucumberStepDefinitions {
  ...
  @Autowired private BagHttpClient bagHttpClient;
  ...
  private void assertNumberOfTimes(
      final int quantity, final String something, final boolean onlyThat) {
